...
sample_rate = 17000/D_measurements
Current_D = 0
...
pyplot.plot(time_axis5[0:17000], vacf_averaged[0:17000], "g.")
pyplot.title("VACF for Rahman Conditions")
pyplot.xlabel("Elapsed Time t (seconds)")
pyplot.ylabel("VACF(t) m^2/s^2")
pyplot.figure()
pyplot.plot(time_axis5[0:17000], normed_vacf_averaged[0:17000], "r")
pyplot.title("Normalised Vacf for Rahman Conditions")
pyplot.xlabel("Elapsed Time t (seconds)")
pyplot.ylabel("VACF(t) / VACF(0)")
pyplot.figure()
